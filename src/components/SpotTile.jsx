export default function SpotTile() {
  ...
  return (
    ...
    >
      <span className="text-[11px] font-medium uppercase tracking-[0.24em] text-slate-400">P1-01</span>
      ...
      {occupied ? (<>
        <span className="mt-2 font-mono text-sm font-semibold text-slate-100">Placa: ABCD12</span>
        <span className="mt-2 font-mono text-sm font-semibold text-slate-100">Apartamento: 5</span>
        </>
      ) : (
